...
class Person {
    ...
    public String surname = JOptionPane.showInputDialog(null, "Please type in your Surname");
    ...
    public double processHousing() {
        ...
        if (OverSpending(availableAmount)) {
            ...
            if (rentChoice == JOptionPane.NO_OPTION) {
                ...
                int buyingchoice = JOptionPane.showConfirmDialog(null, "Do you want to buy property?", "Buying", JOptionPane.YES_NO_OPTION);
...
class CarChoice extends HousingOptions{
...
public class privacyproperty {
    public static void main(String[] args) {
        ...
        // Carchoice choice = new choice();
        CarChoice.choice(remainingBalance);
        // Carchoice choice = new CarChoice();
    }
}